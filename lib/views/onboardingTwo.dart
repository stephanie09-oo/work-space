...
class _OnboardingTwoState extends State<OnboardingTwo> {
    ...
    return Scaffold(
      ...
      body: Padding(
        padding: EdgeInsets.only(
            top: Units.getHeight(context: context, widgetheight: 70)),
        child: Column(
          children: [
            Container(
                alignment: AlignmentDirectional.topEnd,
                child: Customtextbutton(
                    buttonTitle: 'Skip', fontSize: 18, onpressed: () {})
            ),
            SizedBox(
            ...
            Stack(
              ...
              children: [
                Image.asset(AssetsManger.OnboardingviewImage2),
                Container(
                ...
                Center(
                  child: Text( 'Find the practicality in\nmaking your todo list'
            ...
            SizedBox(height: 20,),
            Center(child: Text(  'Easy-to-understand user interface that makes you\n'
  ...
  void GoToNextPage() {
    context.push(Routes.welcomeView);
  }
}